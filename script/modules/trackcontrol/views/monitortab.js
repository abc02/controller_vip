    ...
    render: function() {
        ...
        return (
            <div className="monitorList">
                <div className="monitorAll" style={{color: monitorListTab === 'monitorBottomLineLeft' ? '#172a6a' : ''}} onClick={this.handleChangeMonitorList}>
                    全部({all})
                </div>
                <div className="monitorOnline" style={{color: monitorListTab === 'monitorBottomLineMid' ? '#172a6a' : ''}} onClick={this.handleChangeMonitorList}>
                    在线({online})
                </div>
                <div className="monitorOffline" style={{color: monitorListTab === 'monitorBottomLineRight' ? '#172a6a' : ''}} onClick={this.handleChangeMonitorList}>
                    离线({offline})
                </div>
